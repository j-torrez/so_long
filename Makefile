...
#    Updated: 2023/09/18 20:23:51 by johnbosco        ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INCLUDE = -I./include
SRC = SRC/main.c SRC/parse_map.c SRC/check_valid_map.c SRC/check_valid_map1.c initialize_struct.c utilities.c SRC/load_images.c SRC/generate_map.c SRC/get_position.c SRC/screen_data.c /
OBJ_DIR = obj
