...
/*   Updated: 2023/09/22 12:00:20 by jtorrez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	string_to_screen(t_game *game)
{
	game->img->moves_print = mlx_put_string(game->mlx, 
			"MOVES: ", 16, game->height * 64 - 44);
	if (mlx_image_to_window(game->mlx, game->img->honey, 
			140, game->height * 64 - 50) < 0)
...
void	print_moves(t_game *game)
{
	...
	game->img->moves_nbr = mlx_put_string(game->mlx, str, 
...
void	print_collectibles(t_game *game)
{
	...
	game->img->collectibles_nbr = mlx_put_string(game->mlx, str, 
